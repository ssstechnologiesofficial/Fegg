...
//         Class 12 (Hindi) - Previous Year Papers
//       </h2>
...
// export default Class12HindiPapers
...
const Class12HindiPapers = () => {
  ...
  // प्रश्न पत्रों को विषय अनुसार समूहित करें
  const groupedPapers = papers.reduce((acc, paper) => {
    const { subject } = paper
    if (!acc[subject]) acc[subject] = []
    acc[subject].push(paper)
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      <h2 className="text-2xl font-bold text-center text-[#fd645b] mb-4">
        कक्षा 12 (हिंदी) - पिछले वर्षों के प्रश्न पत्र
      </h2>
                    ...
                    {groupedPapers[subject].map((paper) => (
                      <li key={paper._id} className="mb-2">
                        ...
                        <a
                          ...
                          rel="noopener noreferrer"
                          className="text-blue-500 underline ml-2"
                          style={{ pointerEvents: 'auto' }} // यह सुनिश्चित करें कि यह क्लिक करने योग्य है
                        >
                          पीडीएफ डाउनलोड करें
                        </a>
                      </li>
