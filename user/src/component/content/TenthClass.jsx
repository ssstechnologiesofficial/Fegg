...
const eligibilityData = [
  ...
  { category: 'Maximum Age', details: 'No Restriction' },
  {
    ...
    details: (
      <>
        - Transfer Certificate from the last attended school or original mark
        sheet of 5th, 8th, or 10th board exam.
        <br />
        - Certified copy of the birth certificate issued by Gram Panchayat,
        Municipal Council, or Corporation.
        <br />- For students born before 1989 who have never enrolled in any
        school, an affidavit mentioning the correct date of birth is required.
      </>
    ),
  },
...
const planData = [
  {
    ...
    documents: (
      <>
        ...
        <br />- Transfer Certificate/Original Mark Sheet if formal education was
        obtained
      </>
    ),
  },
  ...
  },
  {
    ...
    documents: (
      <>
        ...
        <br />- Exams available in Hindi & English, with language choices
        including Hindi, English, Sanskrit, and Urdu
      </>
    ),
  },
...
const TenthClass = () => {
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-lg sm:text-2xl font-semibold text-white text-center my-5 border-[#fd645b] border-x-4 bg-[#00043c] pt-1 py-1 w-full">
        Class 10th Eligibility & Required Documents
      </h1>
      <h3 className="text-lg text-center mb-6">
        The following qualifications and documents are required for admission to
        the M.P.S.O.S.E.B. examinations:
      </h3>
      ...
      {/* Plans Table */}
      <h2 className="text-lg sm:text-2xl font-semibold text-white text-center my-5 border-[#fd645b] border-x-4 bg-[#00043c] pt-1 py-1 w-full">
        Operated Plans
      </h2>
      <div className="overflow-x-auto">
        <table className="w-full border-collapse border border-gray-300">
