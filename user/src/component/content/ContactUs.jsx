  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-start lg:items-center lg:space-x-10 py-12 px-4 lg:px-12 bg-gray-50">
      ...
      <div className="flex flex-col lg:flex-row w-full gap-10">
        {/* Left Side - मध्य प्रदेश राज्य मुक्त स्कूल शिक्षा बोर्ड */}
        <div className="w-full lg:w-1/2 border shadow-lg border-[#fd645b] rounded-xl p-6 bg-white">
          ...
          <p className="mb-4">
            <strong>Address:</strong> जोन-I, बोर्ड ऑफिस परिसर, राज्य ओपन स्कूल शिक्षा बोर्ड भवन, शिवाजी नगर, भोपाल, मध्य प्रदेश 462016
          </p>
          <p className="mb-4"><strong>Phone No.:</strong> 0755 - 2552106, 2671066</p>
          <p className="mb-4">
            <strong>Email:</strong> 
          ...
          <p className="mb-4">
            ...
            <a href="https://maps.app.goo.gl/pmxA9NSM3XaduBSS6" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline"> View Location</a>
          </p>
        ...
        {/* Right Side - एजुकेट गर्ल्स */}
        <div className="w-full lg:w-1/2 border shadow-lg border-[#fd645b] rounded-xl p-6 bg-white">
          <h2 className="text-3xl font-bold text-primary mb-4">एजुकेट गर्ल्स</h2>
          <h3 className="text-xl font-semibold text-gray-700 mb-4">इंदौर रीजनल ऑफिस</h3>
          <p className="mb-4">
            <strong>Address:</strong> 69, एमआर-1, अर्चना मोहना क्लिनिक के पीछे, महालक्ष्मी नगर, इंदौर, मध्य प्रदेश 452001
          </p>
          <p className="mb-4">
            <strong>Email:</strong> 
          ...
          <p className="mb-4">
            <strong>Google Map:</strong> 
            <a href="https://maps.app.goo.gl/Jt6D4EBfo8bTgBEB6" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline"> View Location</a>
          </p>
