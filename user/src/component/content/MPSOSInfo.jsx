...
const MPSOSInfo = () => {
  ...
  return (
    <div ref={footerRef} className="flex flex-col justify-center items-center w-full px-4 sm:px-10">
      <div className="p-6 sm:px-20 px-10 bg-gray-100 rounded-lg shadow-md shadow-[#fd645b] sm:mx-40 sm:my-10 flex flex-col items-center MPSOS-section w-full">
        ...
        <p className="text-gray-700 leading-relaxed text-center">
          मध्य प्रदेश में सबके लिए शिक्षा के लक्ष्य की प्राप्ति हेतु वैकल्पिक शिक्षा की आवश्यकता को दृष्टिगत रखते हुए
          मध्य प्रदेश में राष्ट्रीय मुक्त विद्यालयी शिक्षा संस्थान, नई दिल्ली के अनुरूप म.प्र. राज्य मुक्त स्कूल शिक्षा बोर्ड
          की स्थापना मंत्रिपरिषद के निर्णय दिनांक <strong className="text-[#fd645b]">29/03/1995</strong> के फलस्वरूप की गई।
          यह संस्था अगस्त <strong className="text-[#fd645b]">1995</strong> से स्वायत्तशासी संस्था के रूप में पंजीकृत समिति के रूप में कार्य कर रही है।
        </p>

        <h2 className="text-2xl font-bold text-center mt-6 mb-4">स्टीयरिंग कमेटी</h2>
