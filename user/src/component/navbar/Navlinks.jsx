    ...
    <ul className="absolute left-0 z-10 top-full bg-white shadow-md w-40">
      {menuItems.map((item, index) => (
        ...
        >
          ...
          <NavLink to={item.link} className="dropdown-item border-t py-2 px-4 block">
            {item.label}
          </NavLink>
        )}
          ...
          {item.hasSubMenu === "class10" && isClass10Open && (
            <ul className="absolute left-full top-0 bg-white shadow-md w-40">
              ...
              <li className="border-l-4 border-red-500">
                <button onClick={downloadPDF} className="block py-2 px-4 w-full text-left">
                  विवरणिका (Downloadable/ View PDF)
                </button>
              </li>
            </ul>
          )}
  ...
  return (
    <div className="flex items-center justify-between px-12">
        ...
        >
          ...
          {isProgrammesOpen &&
            dropdownMenu([
              ...
              { link: "/10th-class", label: "10वीं कक्षा", hasSubMenu: "class10" },
              { link: "/12th-class", label: "12वीं कक्षा", hasSubMenu: "class12" },
            ])}
        </li>
        <li
          className="relative group"
        ...
        >
          ...
          {ismpsosOpen &&
            dropdownMenu([
              ...
              { link: "https://www.aisectonline.com", label: "EG login to AISECT", isExternal: true }
      ...
      <ul className="flex space-x-8">
        <li>
          <NavLink to="/register" className="py-2">छात्र पंजीकरण</NavLink>
        </li>
        <li>
